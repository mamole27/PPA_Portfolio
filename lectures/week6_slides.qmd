...
boston <- read_csv(here("lectures/boston.csv"))
...
nhoods <- read_sf(here("lectures/BPDA_Neighborhood_Boundaries.geojson")) %>%
...
# load data
bostonCrimes <- read_csv(here("lectures/bostonCrimes.csv"))
...
nhoods <- st_read(here("lectures/BPDA_Neighborhood_Boundaries.geojson")) %>%
  st_transform('ESRI:102286')

...
You can also do this in GitHub Desktop, which will probably be easier at first,
but slower in the long run. Following is the bash code.
...
1. Go to the [course repository](https://github.com/allisonlass/CPLN-5920-SP26)
...
3. **Commit your changes:** 
   (You can use GitHub Desktop here as well)
   ```bash
   git add .

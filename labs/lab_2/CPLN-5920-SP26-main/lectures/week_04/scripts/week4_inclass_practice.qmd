...
area_comparison <- pa_counties %>%
  ...
  # PA State Plane South - Good for PA. This is the meters projection (can also project to ft with 2271)
  st_transform(32129) %>%
  ...
  mutate(
    ...
    error_state_plane_pct = abs(area_state_plane - area_albers) / area_albers * 100
  )
